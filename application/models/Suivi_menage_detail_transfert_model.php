...
class Suivi_menage_detail_transfert_model extends CI_Model
{
    protected $table = 'suivi_menage_detail_transfert';


	// TABLE CONCERNEE DANS LA BDD : suivi_menage_detail_transfert
	// Cette fonction ajoute un enregistrement dans la table
    public function add($suivi_menage_detail_transfert)
    {
        $this->db->set($this->_set($suivi_menage_detail_transfert))
                            ->insert($this->table);
    ...
    {
       return array(
            'id_suivi_menage_entete' => $suivi_menage_detail_transfert['id_suivi_menage_entete'],                      
            'id_detail_type_transfert' => $suivi_menage_detail_transfert['id_detail_type_transfert'],                      
    ...
    public function findAllByProgramme($id_interventions)
    {
        $result =  $this->db->select('menage.id as id_individu,
                                        suivi_menage_detail_transfert.id as id,
                                        ...
                                        ')
                        ->from($this->table)
                        ->join('menage', 'menage.id = suivi_menage_detail_transfert.id_individu')
                    //    ->order_by('id')
    ...
    public function findAllByProgrammeAndIndividu($id_interventions,$id_individu)
    {
		$requete="select sm.id,sm.id_individu,i.nom,i.prenom,i.date_naissance,"
				...
				." from suivi_menage_detail_transfert as sm"
